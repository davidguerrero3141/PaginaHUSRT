                        ...
                        <div class="card r-0 shadow">
								<table class="table table-bordered">
                                    ...
                                    <tr>
										...
										<?php $ssql = "Select * from adm_hsrt";
								$result = $conn->query($ssql);
  								if ($result->num_rows > 0) {
      							while($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        <td><?php echo $row["nombre"]; ?></td>
										<td><img src="<?php echo $row["imagen"]; ?>" width="50px"></td>
										<td><?php echo $row["email"]; ?></td>
										<td><a class="btn btn-danger btn-sm" href="borrado.php?tabla=adm_hsrt&id=<?php echo $row["id"]?>" onclick='clicked(event)'>Borrar</a></td>
                                    </tr>
                                    <?php }} else { echo ""; } ?>
                                    </tbody>
                                </table>
							<div class="card-body b-b">
							<form action="agregado_usuario.php" method="post" enctype="multipart/form-data">
                            <h2>Agregue un nuevo administrador:</h2>
							...
							<div class="form-group">
                                ...
                                <input class="form-control form-control-lg" type="text" id="usuario" name="usuario" required>
                            </div>
							<div class="form-group">
							...
							<div class="form-group">
                                ...
                                <input class="form-control form-control-lg" type="password" id="clave" name="clave" required>
                            </div>
