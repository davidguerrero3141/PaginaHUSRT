                        ...
                        <div class="card-body b-b">
							<table class="table table-bordered">
                                    ...
                                    <tr>
										...
										<?php $ssql = "Select DISTINCT ano,mes from ".$_GET['encuesta']." ORDER BY ano,mes";
								$result = $conn->query($ssql);
      							...
      							while($row = $result->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td><a class="<?php echo $button ?>" href="encuesta.php?encuesta=<?php echo $_GET["encuesta"] ?>&ano=<?php echo $row["ano"] ?>&mes=<?php echo $row["mes"] ?>">VER RESULTADOS</a></td>
                                    </tr>
                                    <?php }} else { echo ""; } ?>
                                    </tbody>
                                </table>
