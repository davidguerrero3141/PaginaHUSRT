                ...
                <div class="col-lg-12">
                    <div class="binduz-er-video-post-topbar">
                        <div class="binduz-er-video-post-title">
                            <h3 class="binduz-er-title"><?php $slug = $_GET['subseccion']; $slug = str_replace("-", " ", $slug); $slug = ucfirst($slug); echo $slug; ?></h3>
                        </div>
                    </div>
                    <div class="row">
                        <?php $ssqlart = "Select id,fecha_publicado,fecha_modificado,slug,seccion,subseccion,titulo,subtitulo,publicar,imagen,contenido,resumen,prioridad,vinculo,blank from articulos WHERE subseccion = '".$_GET['subseccion']."' AND publicar = 1 ORDER BY prioridad";
                            ...
                            <div class="binduz-er-main-posts-item">
                                <div class="binduz-er-trending-news-list-box">
									...
									<div class="binduz-er-thumb">
                                        <img src="<?php echo $imagen ?>" alt="<?php echo $titulo_sitio ?>">
                                    </div>
									<?php } else { ?>
                                    <div class="binduz-er-thumb">
                                        <img src="<?php echo $rowart["imagen"] ?>" alt="<?php echo $rowart["titulo"] ?>">
                                    </div>
									<?php } ?>
                                    <div class="binduz-er-content">
                                        ...
                                        <div class="binduz-er-trending-news-list-title">
                                            <h4 class="binduz-er-title"><?php if ($vinculoart == ''){ ?><a href="contenido.php?seccion=<?php echo $rowart['seccion'];?>&slug=<?php echo $rowart['slug'];?>"><?php echo $rowart['titulo'] ?></a><?php } else { ?><a href="<?php echo $vinculoart;?>" target="<?php if ($blankart == 1) { echo "_blank"; } else { echo "_self"; } ?>"><?php echo $rowart['titulo'] ?></a><?php } ?></h4>
