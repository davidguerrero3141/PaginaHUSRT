                ...
                <div class="col-lg-12">
                    <div class="binduz-er-video-post-topbar">
                        <div class="binduz-er-video-post-title">
                            <h3 class="binduz-er-title">Servicios</h3>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="binduz-er-main-posts-item">
                                <div class="binduz-er-trending-news-list-box">
                                    <div class="binduz-er-thumb">
                                        <img src="<?php echo $rowss["imagen"] ?>" alt="<?php echo $rowss["nombre"] ?>">
                                    </div>
                                    <div class="binduz-er-content">
                                        ...
                                        <div class="binduz-er-trending-news-list-title">
                                            <h4 class="binduz-er-title"><a href="intro.php?seccion=servicios&slug=<?php echo $rowss['subseccion'] ?>"><?php echo $rowss['nombre']; ?></a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
