            ...
            <div class="fact-counter">
                <div class="row clearfix">
					...
					<h2>Nuestro personal revisará los datos y le informaremos la confirmación de su cita en un plazo de hasta 72 horas.</h2>
							<h2>Para poder agendar su cita debe tener a la mano la orden y autorización de la cita.</h2>
        ...
        <div class="auto-container">
            <div class="row clearfix">
                <div class="column col-lg-12 col-md-12 col-sm-12">
					...
					<p>Para poder agendar su cita debe tener a la mano la orden y autorización de la cita.</p>
					<a href="salida.php" class="theme-btn btn-style-four">CONTINUAR</a>
            </div>
        </div>
    </section>
