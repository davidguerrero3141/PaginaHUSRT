        ...
        <div class="auto-container">
            <div class="row clearfix">
				<div class="column col-lg-6 col-md-12 col-sm-12">
					...
					<p>El usuario con número de documento <?php echo $_GET['cedula'] ?> ya está registrado, verifique la información o si desea recuperar su contraseña <a href="#">ENTRE AQUÍ</a></p>
                ...
                <div class="column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="login-form register-form">
                        <!--Login Form-->
                        <form method="post" action="registrado_usuario.php">
