...
try {
    ...
    $mail->Body    = '
						...
						<body>
							 ...
							 <p>'.$nombres. ' '.$apellidos. ', sus datos han sido registrados en nuestra base de datos, a partir de ahora puede ingresar a nuestra página web con tu número de cédula y solicitar sus citas médicas.</p>
