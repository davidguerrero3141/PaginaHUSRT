...
$salt_nombres = $_SESSION['s_nombres'];
$salt_apellidos = $_SESSION['s_apellidos'];
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="page-wrapper">
    ...
    <section class="page-title" style="background-image:url(images/background/18.jpg);">
        ...
        <div class="auto-container">
            <h2 style="color: #2D2D2D">Bienvenid@ <?php echo $salt_nombres ?> <?php echo $salt_apellidos ?></h2>
        </div>
    </section>
    <!--End Page Title-->
            ...
            <div class="fact-counter">
                <div class="row clearfix">
                    ...
                    <div class="counter-column col-lg-12 col-md-12 col-sm-12 wow fadeInUp">
                        <div class="count-box">
                            <h3>Pida su cita médica en el formulario que encuentra a continuación, nos estaremos comunicando posteriormente para confirmarla</h3>
							<h3>Si desea actualizar sus datos de contacto <a href="actualizar.php">INGRESE AQUÍ</a></h3>
                        </div>
                    </div>
                        ...
                        <form method="post" action="registrado_cita.php">
                           ...
                           <div class="form-group">
							...
							<?php $ssqlpac = "Select * from clientes where cedula = '".$_SESSION['s_cedula']."'";
								...
								?>
                            <input type="hidden" name="telefono" value="<?php echo base64_decode($rowpac['telefono']) ?>">
							<input type="hidden" name="celular" value="<?php echo base64_decode($rowpac['celular']) ?>">
