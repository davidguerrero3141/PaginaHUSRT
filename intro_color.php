                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="binduz-er-footer-widget-style-1">
                                <div class="binduz-er-footer-menu-list">
                                    <ul>
                                        <li><a href="#">Call center citas: <?php echo $telefono_citas ?></a></li>
										<li><a href="mailto:<?php echo $email ?>">Atención al Usuario: <?php echo $email ?></a></li>
                                        <li><a href="mailto:<?php echo $email_juridico ?>">Notificaciones: <?php echo $email_juridico ?></a></li>
                                        <li><a href="mailto:<?php echo $email_solicitudes ?>">Solicitudes: <?php echo $email_solicitudes ?></a></li>
