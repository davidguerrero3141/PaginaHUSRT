        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <?php $ssqlart = "Select id,fecha_publicado,fecha_modificado,slug,seccion,subseccion,titulo,subtitulo,publicar,imagen,contenido,resumen,prioridad,vinculo,blank from articulos WHERE seccion = 'novedades' AND publicar = 1 ORDER BY prioridad";
